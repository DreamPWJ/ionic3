...
export class MyApp {
  ...
  constructor(public platform: Platform,  statusBar: StatusBar,  splashScreen: SplashScreen, private ionicApp: IonicApp, private toastCtrl: ToastController, private keyboard: Keyboard) {
    platform.ready().then(() => {
